...
insert into UserAccount (name, password, roles, facilityNpi) values ('userEhr', '', 'EHR', '1003906488');
insert into UserAccount (name, password, roles, facilityNpi) values ('userGovt', '', 'GOVT', '1417101098');
insert into UserAccount (name, password, roles, facilityNpi) values ('userFsa', '', 'FSA', '1053866467');
